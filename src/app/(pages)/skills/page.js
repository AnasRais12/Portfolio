...
const Skills = forwardRef((props, ref) => {
  return (
    <>
      <div ref={ref}
        className={`boxes-skill relative w-full py-16  bg-[#0f0d0d] dark:bg-gray-100  border-b-4 font-bold flex flex-col gap-8`}
      >
        <h1
          ...
          <div className="gap-10 px-[3%] lg:px-[8%]   py-[2%] grid md:grid-cols-3 grid-cols-2 justify-between font-sans text-[18px] items-center">
            {techStack.map((el, index) => (
              <div
                ...
                className=" box2 sm:justify-center justify-center py-4 px-4 bg-gray-50 shadow-md dark:shadow-lg   shadow-gray-500 md:m-4  mt-6 rounded-lg flex items-center hover:scale-125 cursor-pointer duration-500"
              >
